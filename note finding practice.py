...
def endGame():
    ...
    icr_label = tk.Label(end_screen, text = 'How many you absolutely fucked up: ', font = 'Helvetica 13').grid(row = 2, column = 0, padx = padding_x, pady = padding_y, sticky ='W')
    ...
    if incorrects/(corrects + incorrects) >= 1/2:
        feedback = tk.Label(text = "Go practice you trash", font = 'Helvetica 14', anchor ='w').grid(row=5,column = 0, columnspan = 2, sticky = tk.W+tk.E, padx = padding_x, pady = padding_y + 6)
    elif incorrects/corrects <= 1/2 and incorrects:
        feedback = tk.Label(text = "Not bad ngl", font = 'Helvetica 14', anchor ='w').grid(row=5,column = 0, columnspan = 2, sticky = tk.W+tk.E, padx = padding_x, pady = padding_y + 6)
    elif incorrects == 0:
        feedback = tk.Label(text = "Just lucky this time", font = 'Helvetica 14', anchor ='w').grid(row=5,column = 0, columnspan = 2, sticky = tk.W+tk.E, padx = padding_x, pady = padding_y + 6)
    end_screen.mainloop()
updateClock()
nextMeme()
